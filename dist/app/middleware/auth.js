...
const auth = (...userRoles) => (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        //
        ...
        const currentUser = yield user_model_1.User.findById(verifiedUser === null || verifiedUser === void 0 ? void 0 : verifiedUser.id);
